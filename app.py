    ...
    with Session(db.engine) as session:
        with session.begin():
            customers = [
                ...
                Customer(name="Customer Two", email="custome2@example.com", phone="092319283"),
                Customer(name="Customer Three", email="customer3@example.com", phone="092319283"),
            ]

            customersAccounts = [
                CustomerAccount(username="ctm1", password=generate_password_hash("password1"), customer_id=1), #hashes the passwords
